...
public class SeedDatabase
{
    ...
    public async static Task Initialize(IHost host)
    {
        using var scope = host.Services.CreateScope();
        {
            ...
            // apply pending migrations (no need for `dotnent ef database update`)
    ...
    private async static Task SeedReviews()
    {
        ...
        uni.Reviews.Add(GenerateReview("He was the strongest", "He was always trying to fight me... What might be going on behind those eyes if his?", 4));
        uni.Reviews.Add(GenerateReview("What a baby", "He ate a whole rotisserie chicken in one gulp! Wow!", 5));
        goof.Reviews.Add(GenerateReview("Kinda scary", "I am pretty sure that that's a real man trapped in a cat's physique...", 1));
        milly.Reviews.Add(GenerateReview("What a silly billy", "That might be the silliest cat I have ever seen.", 5));
        oye.Reviews.Add(GenerateReview("Woah, very powerful", "He just broke through my wall, I did not even know of this service before.", 3));
